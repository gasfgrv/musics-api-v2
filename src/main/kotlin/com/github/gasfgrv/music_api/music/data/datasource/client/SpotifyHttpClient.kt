...
class SpotifyHttpClient(
    ...
    override fun getTrackInfo(music: Music): Music {
        ...
        val spotifyResponse = SpotifyResponse(
    ...
    private fun getAlbumResponse(body: String): SpotifyResponse.Album = SpotifyResponse.Album(
    ...
    private fun <T> extractResponseAttribute(responseBody: String, jsonPathExpression: String): T =
        JsonPath.parse(responseBody).read(jsonPathExpression)
